...
<html lang="fr">
  ...
  <body id="homepage">
    ...
    ?>
     <!-- TODO : Diminuer la largeur du bloc pour créer un espacement entre le texte de gauche et de droite -->
    <main class="mt-5 mx-auto d-flex flex-column align-items-center flex-lg-row">
      <section class="mt-5 p-4 px-xxl-0 pt-lg-5">
      ...
      <section class="p-4 d-flex flex-column align-items-center">
        <figure class="mx-auto">
          <img src="assets/img/homepage-illustration.png" class="w-100">
          <!-- TODO : Voir si illustration disponible en SVG -->
        </figure>
